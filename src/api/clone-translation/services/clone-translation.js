...
const SINGLE_TYPES = [
  {
    ...
    populate: ["banner_img", "section_img"],
  },
  { uid: "api::menyu.menyu", populate: "*" },
  { uid: "api::teksty.teksty", populate: "*" },
  {
    uid: "api::o-kompanii.o-kompanii",
    populate: ["first_image", "second_image", "third_image", "main_image"],
  },
  {
    uid: "api::ingredienty-stranicza.ingredienty-stranicza",
    populate: ["food_image", "pharm_image", "cosm_image", "banner"],
  },
];
...
const SIMPLE_COLLECTIONS = [
  ...
  { uid: "api::tovary-glavnaya.tovary-glavnaya", populate: ["image"] },
